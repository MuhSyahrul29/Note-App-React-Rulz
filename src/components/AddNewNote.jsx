  ...
  return (
    <div className=" select-none my-3 xx:basis-1/3 mm:w-2/3 mm:max-w-96 ss:w-[80%] xl:mt-12 xg:mt-16 xx:mt-16 mm:mt-14 ss:mt-16 w-full  ">
      ...
      <form className=" flex flex-col mt-6" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="  w-full xl:w-full xg:w-[87%] xx:w-[83%] mx-auto bg-[#FFA000] px-8 py-3 rounded-xl font-medium 2xl:text-[18px] xg:text-[17px] xx:text-[16.5px] mm:text-[16px] ss:text-[15.5px] text-white xl:mt-5 xg:mt-8 xx:mt-7 mm:mt-6 ss:mt-6 cursor-pointer"
        >
          Add New Note
        </button>
      </form>
