...
function NoteHeader({ sortBy, onSortNotes }) {
  return (
    <div className="  w-full ss:pt-4 mm:pt-0 2xl:h-20 xl:h-[76px] xx:h-[70px] mm:h-[68px] ss:h-auto mm:py-0 ss:py-3 bg-green-200 dark:bg-gray-900/40 ww:rounded-xl  ss:rounded-b-lg mm:rounded-xl flex items-center justify-around flex-wrap ss:gap-x-9 ss:px-5 mm:gap-y-0 ss:gap-y-3  2xl:mt-6 xl:mt-5 xx:mt-5 mm:mt-3 mm:w-[95%] ">
      <h2 className=" font-bold  2xl:text-[30px] xl:text-[28.5px] xg:text-[26px] xx:text-[24px] mm:text-[22px] ss:text-[22px] my-0  bg-gradient-to-r text-[#FFA000] dark:bg-gradient-to-r  inline-block  bg-clip-text   ">
        Rulztarito Note App{" "}
      </h2>
